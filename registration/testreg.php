...
if (isset($_POST['password'])) {$login = $_POST['password']; if ($password=='') {unset($password); } }
...
$result = mysql_query($db,"SELECT * FROM users WHERE login='$login'"); //извлекаем из базы все данные о пользователе с введенным логином
